...
describe("main", () => {
  ...
  // Don't muck with the child components in this test, that's going too deep
  // Just test exactly what Main itself is supposed to do,
  //not it's child components details
